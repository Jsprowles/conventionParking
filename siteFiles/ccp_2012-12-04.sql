...
# Database: ccp
# Generation Time: 2012-12-04 21:38:23 +0000
# ************************************************************
...
VALUES
	...
	(722,1,NULL,NULL,'Example',720,725),
	(723,722,NULL,NULL,'admin_index',721,722),
	(724,722,NULL,NULL,'index',723,724);
...
VALUES
	(3,4,'About','about','This is a live demonstration of the qParc™ Parking Website Management System.',1,'',1,1,'','','','','','2012-07-01 04:29:46','2009-07-26 17:13:14'),
	(8,8,'Search','search','',0,'',0,3,'search','','','','','2012-07-01 05:04:16','2009-12-20 03:07:27'),
	(5,4,'Meta','meta','[menu:meta]',1,'',1,6,'','[\"1\",\"2\"]','','','','2012-07-01 05:04:12','2009-09-12 06:36:22'),
	(7,4,'Categories','categories','[vocabulary:categories type=\"blog\"]',1,'',1,4,'','[\"1\",\"2\"]','','','','2012-07-01 05:04:15','2009-10-03 16:52:50'),
	(9,4,'Recent Posts','recent_posts','[node:recent_posts conditions=\"Node.type:blog\" order=\"Node.id DESC\" limit=\"5\"]',1,'',1,5,'','[\"1\",\"2\"]','','','','2012-07-01 05:04:13','2009-12-22 05:17:32'),
	(12,0,'Twitter Profile Widget','twitter_profile_widget','[element:twitter_profile_widget plugin=\"seo\"]',0,NULL,0,7,NULL,'[\"1\",\"2\",\"3\",\"4\",\"5\",\"6\"]','',NULL,NULL,'2012-07-01 05:04:10','2012-06-13 14:10:47'),
	(14,4,'User Registration','registration','',1,'',1,2,'register','[\"3\"]','[\"/qparc/about\",\"/qparc/\",\"/qparc/users/login\"]',NULL,'','2012-07-01 05:04:18','2012-06-22 03:52:27'),
	(15,4,'Reservations','reservations','',1,'',0,8,'Qparc.reservation','','',NULL,'','2012-07-01 05:04:09','2012-06-22 22:50:34'),
	(18,20,'Site Logo','logo','<img src=\"/qparc_web/img/logo-main.png\" />',0,'',1,9,'','','',NULL,'','2012-07-01 05:04:06','2012-06-29 19:20:56');
...
VALUES
	(1,NULL,1,0,'qParc','email@qparc.net','http://www.qparc.net','127.0.0.1','','qParc™ features all aspects of content management as well as parking management. Commenting, blogs, and many social features are all built in and ready to go.',NULL,1,0,'blog','comment',1,2,'2009-12-25 12:00:00','2009-12-25 12:00:00');
...
VALUES
	...
	(8,NULL,3,'About','about','','/about','','',1,7,8,'[\"3\"]','','2012-06-29 19:28:18','2009-09-06 21:34:57'),
	...
	(24,NULL,3,'Reservations','','','/reservations','','',1,9,10,'','','2012-06-22 04:03:33','2012-06-20 20:08:03'),
	(27,NULL,3,'Locations','locations','','/locations','','',1,11,12,'','','2012-06-22 19:36:59','2012-06-22 19:36:59'),
	(29,NULL,3,'My Profile','my-profile','','/profile','','',1,13,14,'[\"1\",\"2\"]','','2012-06-29 00:30:32','2012-06-29 00:30:32'),
	(30,NULL,3,'Example','example',NULL,'plugin:example/controller:example/action:index',NULL,NULL,1,17,18,NULL,NULL,'2012-12-04 21:17:59','2012-12-04 21:17:59');
...
VALUES
	(3,'Test Location One','777 Main Street, Hartford CT.',41.7657,-72.6733,1,0,'Terms...',1,0,0,0,'2012-06-20 21:07:08','2012-07-01 05:22:43'),
	(4,'Another Location','750 Main Street, Hartford CT',41.7654,-72.6733,1,0,'',0,0,0,0,'2012-06-21 03:22:48','2012-06-22 17:51:12'),
	(8,'Location with Settings','11 Red Yellow Road Middletown CT.',41.5273,-72.6803,1,0,'',1,0,NULL,NULL,'2012-06-28 16:42:18','2012-06-29 01:21:04');
...
VALUES
	(3,'Main Menu','main','','',1,NULL,7,'','2009-08-19 12:21:06','2009-07-22 01:49:53'),
...
VALUES
	(1,NULL,1,'Welcome to The qParc™ Demo Site','welcome','<p><strong>qParc&trade;</strong> is a cloud based content management system for parking websites. It facilitates all aspects of online parking needed to run a successful parking website in the cloud, and includes instant, turn-key integration with popular hardware manufacturers and systems including Amano McGann iParc Professional. With qParc&trade; you can have a full featured parking website, on the cloud, integrating with your hardware and taking online payments in minutes.</p>\r\n<p><strong>Demo Account</strong> (Login above with the following credentials)<br />Username: demonstration<br />Password: demonstration</p>','',1,'',2,1,1,'/blog/welcome','{\"1\":\"uncategorized\"}',0,1,2,'[\"3\"]','blog','2012-07-01 04:52:51','2009-12-25 11:00:00'),
	(2,NULL,1,'About','about','<h3><strong>Overview</strong></h3>\r\n<p>qParc&trade; is a cloud based content management system for parking websites. It facilitates all aspects of online parking needed to run a successful parking website in the cloud, and includes instant, turn-key integration with popular hardware manufacturers and systems including Amano McGann iParc Professional. With qParc&trade; you can have a full featured parking website, on the cloud, integrating with your hardware and taking online payments in minutes.</p>\r\n<h3><strong>Key Features</strong></h3>\r\n<ul>\r\n<li>Full Content, Menu, and Template Management</li>\r\n<li>Full User and Registration Management</li>\r\n<li>Built in SEO and Seamless Social Integration for Facebook and Google+.</li>\r\n<li>Blog Content integration with Built in user commenting</li>\r\n<li>Multi-locale support for multiple languages</li>\r\n<li>Instant / Seamless Mobile Device Integration</li>\r\n<li>Seamless integration with Amano iParc Parking Management Software.</li>\r\n<li>Coupon/Promotions Management</li>\r\n<li>User Reservations Management</li>\r\n<li>Blackout Date Management</li>\r\n<li>Seamless payment gateway integration with Authorize.net for online payments.</li>\r\n<li>Rich Dashboard analytics for monitoring/viewing user data</li>\r\n<li>Amazon Web Services integration</li>\r\n</ul>\r\n<h3><strong>Setup / Installation</strong></h3>\r\n<p>The qParc&trade; software is Free and Open Source. It is purchasable and instantly available through the Amazon Web Services Marketplace. All you need is an Amazon AWS account. Professional software setup and installation is also available and provided through Code Creator, as well as professional support and maintenance packages and customization solutions.</p>\r\n<p><a href=\"https://aws.amazon.com/marketplace/seller-profile/ref=dtl_php_sold_by?ie=UTF8&amp;id=1c50d45e-d7a2-412b-825a-ab599088519e\" target=\"_blank\"><img src=\"/qparc/uploads/aws-marketplace.png\" alt=\"Amazon Marketplace\" width=\"266\" height=\"69\" /></a></p>','',1,'',0,0,0,'/about','',0,1,2,'','page','2012-06-29 20:21:49','2009-12-25 22:00:00'),
	...
	(4,NULL,1,'Welcome to The qParc™ Demo','welcome-to-the-qparc-demo','<p><strong>Reservations</strong><br />Click on Reservations to view all your current reservations, as well as print confirmation and promotions. Within reservations your can easily jump between different locations and easily access all your reservations and confirmations. You can also edit your reservation.</p>\r\n<p><strong>Locations</strong><br />Here you can view all available locations in both a list view, and on a Google Map. You can see all parking reservation options available for each location, and begin a reservation.</p>\r\n<p><strong>My Profile</strong><br />Your Profile is where you manage your personal, vehicle, and payment information used when creating a reservation. Your payment information is securely stored withing Authorize.net\'s <a title=\"Authorize.net Customer Information Manager\" href=\"http://authorize.net/cim/\" target=\"_blank\">Customer Information Manager</a>.</p>','',1,NULL,1,0,1,'/page/welcome-to-the-qparc-demo',NULL,0,3,4,'[\"1\",\"2\"]','page','2012-07-01 05:19:26','2012-07-01 04:53:00');
...
VALUES
	...
	(32,'Hook.bootstraps','Tinymce,SocialBookmarks,Amazon,Qparc,Example','','','',0,23,''),
	...
	(131,'Qparc8.iparc_validation','','','iParc Store Validation Number for location 8','',1,101,''),
	(130,'Qparc8.iparc_enabled','1','','Enable iParc for location 8','',1,100,''),
	(127,'Qparc8.authnet_login','123','','Authorize.net Transaction Key for location 8','',1,97,''),
	(126,'Qparc8.authnet_transaction_key','','','Authorize.net Login for location 8','',1,96,''),
	(125,'Qparc8.email_use_global','1','','Individual Location setting to use Email Settings','',1,95,''),
	(124,'Qparc8.reservations_use_global','1','','Individual Location setting to use Reservations Settings','',1,94,''),
	(123,'Qparc8.iparc_use_global','1','','Individual Location setting to use iParc Integration','',1,93,''),
	(122,'Qparc8.authnet_use_global','1','','Individual Location setting to use Authorize.net','',1,92,''),
	(129,'Qparc8.reservations_show_payment','1','','Show Payment option on reservation for location 8','',1,99,''),
	(128,'Qparc8.reservations_show_promos','0','','Show Promotions on reservation for location 8','',1,98,''),
	(132,'Qparc8.email_enabled','1','','Enable Email Reporting for location 8','',1,102,''),
	(133,'Qparc8.email_frequency','1','','Email Frequency for location 8','',1,103,''),
	(134,'Qparc8.email_addresses','','','Email Addresses for location 8','',1,104,''),
	(136,'Qparc.authnet_test','1','','Authorize.net Login','',1,105,'');
...
VALUES
	...
	(3,1,'parkingio','a837976030085d965b65df4b662f801c1e34728d','parkingio','',NULL,'1bcc05aa0f45bb2ea7fd8e6e30cbda82',NULL,NULL,'0',1,'2012-11-16 02:17:05','2012-11-16 02:17:05'),
	(4,1,'ccdev','6bf82b3efa89e5f1ee4b2714404a95e2e77e3fa9','ccdev','',NULL,'7e4767af3c3a3e569af774adc5913835',NULL,NULL,'0',1,'2012-12-04 21:16:14','2012-12-04 21:16:14');
