...
class GoogleMapV3Helper extends AppHelper {
	...
	protected $_defaultOptions = array(
		...
		'map'=>array(
			...
			'navOptions' => array(),
			'scaleOptions' => array(),
			'defaultLat' => 0, # only last fallback, use Configure::write('Google.lat', ...); to define own one
			'defaultLng' => 0, # only last fallback, use Configure::write('Google.lng', ...); to define own one
			'defaultZoom' => 5,
		),
		'staticMap' => array(
			'size' => '300x300',
