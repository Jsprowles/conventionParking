...
<div id="reserve">
	...
	<?php echo $this->Html->link('Back to Reservations','/admin/qparc/qparc/manage/' . $location['Location']['id'] . "#reservations"); ?>
	</span>
	...
	<div>
		...
		<br/>
		<h3>Promotions (<?=count($location['LocationPromo'])?> available)</a></h3>
		<div>
			<fieldset>
				<table cellspacing="10" cellpadding="10" width="100%">
				<?php
