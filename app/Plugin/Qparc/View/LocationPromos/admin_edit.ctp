	...
	<h3><?php echo $title_for_layout; ?></h3>
		<?php 
			...
			if (!Configure::read('Qparc.iparc_enabled')) {
				...
				echo "<br/>* You have ". $this->Html->link('iParc integration','/admin/qparc/#settings') ." enabled, your QR Code will automatically be generated.<br/>";
			}
			echo "<br/><br/><label>Start Date</label><br/>";
			echo $this->Form->input('start',array('label'=>false,'div'=>false));
			echo "<br/><br/><label>Expiration Date</label><br/>";
			echo $this->Form->input('expiration',array('label'=>false,'div'=>false));
